...
/**
 * Flone Widget layered nav class.
 */
class Flone_Widget_Layered_Nav extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_layered_nav woocommerce-widget-layered-nav flone';
		$this->widget_description = __( 'Display a list of attributes to filter products in your store.', 'flone' );
		$this->widget_id          = 'flone_layered_nav';
		$this->widget_name        = __( 'Flone: Filter Products by Attribute Ajax', 'flone' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'        => array(
				'type'  => 'text',
				'std'   => __( 'Filter by', 'flone' ),
				'label' => __( 'Title', 'flone' ),
			),
			'attribute'    => array(
				'type'    => 'select',
				'std'     => $std_attribute,
				'label'   => __( 'Attribute', 'flone' ),
				'options' => $attribute_array,
			),
			'display_type' => array(
				'type'    => 'select',
				'std'     => 'list',
				'label'   => __( 'Display type', 'flone' ),
				'options' => array(
					'list'     => __( 'List', 'flone' ),
					'dropdown' => __( 'Dropdown', 'flone' ),
				),
			),
			'query_type'   => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => __( 'Query type', 'flone' ),
				'options' => array(
					'and' => __( 'AND', 'flone' ),
					'or'  => __( 'OR', 'flone' ),
				),
	...
	protected function layered_nav_dropdown( $terms, $taxonomy, $query_type ) {
		...
		if ( $taxonomy !== $this->get_current_taxonomy() ) {
			...
			$any_label      = apply_filters( 'woocommerce_layered_nav_any_label', sprintf( __( 'Any %s', 'flone' ), $taxonomy_label ), $taxonomy_label, $taxonomy );
			...
			if ( $multiple ) {
				echo '<button class="woocommerce-widget-layered-nav-dropdown__submit" type="submit" value="' . esc_attr__( 'Apply', 'flone' ) . '">' . esc_html__( 'Apply', 'flone' ) . '</button>';
			}
				...
				if ( jQuery().selectWoo ) {
					var wc_layered_nav_select = function() {
						jQuery( '.dropdown_layered_nav_" . esc_js( $taxonomy_filter_name ) . "' ).selectWoo( {
							...
							language: {
								noResults: function() {
									return '" . esc_js( _x( 'No matches found', 'enhanced select', 'flone' ) ) . "';
								}
							}
						} );
					};
