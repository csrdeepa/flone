...
/**
 * Flone Widget price filter class.
 */
class Flone_Widget_Price_Filter extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_price_filter flone';
		$this->widget_description = __( 'Display a slider to filter products in your store by price.', 'flone' );
		$this->widget_id          = 'floen_woocommerce_price_filter';
		$this->widget_name        = __( 'Flone: Filter Products by Price Ajax', 'flone' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'std'   => __( 'Filter By Price Ajax', 'flone' ),
