...
/**
 * Flone Widget product tag cloud
 */
class Flone_Widget_Product_Tag_Cloud extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_product_tag_cloud flone';
		$this->widget_description = __( 'A cloud of your most used product tags.', 'flone' );
		$this->widget_id          = 'flone_product_tag_cloud';
		$this->widget_name        = __( 'Flone: Product Tag Cloud Ajax', 'flone' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'std'   => __( 'Product Tags Ajax', 'flone' ),
	...
	public function topic_count_text( $count ) {
		...
		return sprintf( _n( '%s product', '%s products', $count, 'flone' ), number_format_i18n( $count ) );
	}
