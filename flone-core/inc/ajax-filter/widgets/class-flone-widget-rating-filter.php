...
/**
 * Flone Widget rating filter class.
 */
class Flone_Widget_Rating_Filter extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_rating_filter flone';
		$this->widget_description = __( 'Display a list of star ratings to filter products in your store.', 'woocommerce' );
		$this->widget_id          = 'flone_rating_filter';
		$this->widget_name        = __( 'Flone: Filter Products by Rating Ajax', 'woocommerce' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'std'   => __( 'Filter By Rating Ajax', 'woocommerce' ),
