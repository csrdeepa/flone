...
<div class="currencies-container">
	<h2><?php _e( 'All Currencies', 'flone' ); ?></h2>
	<div class="currencies-list">
		<?php $default = Flone_Wc_Currency::woo_currency(); ?>
		<table>
			<thead>
				<tr>
					<th><?php _e( 'Currency', 'flone' ); ?></th>
					<th><?php _e( 'Currency Position', 'flone' ); ?></th>
					<th><?php _e( 'Thousand Separator', 'flone' ); ?></th>
					<th><?php _e( 'Decimal Separator', 'flone' ); ?></th>
					<th><?php _e( 'Number of Decimals', 'flone' ); ?></th>
					<th><?php printf( __( 'Exchange Rate(In %s)', 'flone' ), $default['currency'] ); ?></th>
					<th><?php _e( 'Action', 'flone' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<tr class="tr-not-found">
					<td colspan="7"><p style="text-align: center"> <?php _e( 'No currency found ...', 'flone' ); ?> </p></td>
				</tr>
			</tbody>
			<tfoot>
			<tr class="currencies-list-footer">
				<td colspan="7">
					<div class="currency-action" style="text-align: right;">
						<a class="button button-secondary" id="update-currency-rate" href="javascript:void(0);"><?php _e( 'Update Rate', 'flone' ); ?></a>
						<a class="button button-primary" id="add-new-currency" href="javascript:void(0);"><?php _e( 'New Currency', 'flone' ); ?></a>
					</div>
				</td>
			</tr>
			</tfoot>
...
<div id="dialog" title="<?php _e( 'New Currency', 'flone' ); ?>" style="display: none;">
	<?php
	...
	<form id="currency-form">
		...
		<ul>
			<li>
				<div class="frm-label"><?php _e( 'Currency', 'flone' ); ?></div>
				<div class="frm-input">
			...
			<li>
				<div class="frm-label"><?php _e( 'Currency Position', 'flone' ); ?></div>
				<div class="frm-input">
					<select name="woocommerce_currency_pos" id="woocommerce_currency_pos"  class="wc-enhanced-select enhanced" tabindex="-1" title="Currency Position">
						<option value="left" selected="selected"><?php _e( 'Left ($99.99)', 'flone' ); ?></option>
						<option value="right"><?php _e( 'Right (99.99$)', 'flone' ); ?></option>
						<option value="left_space"><?php _e( 'Left with space ($ 99.99)', 'flone' ); ?></option>
						<option value="right_space"><?php _e( 'Right with space (99.99 $)', 'flone' ); ?></option>
					</select>
				</div>
			</li>
			<li>
				<div class="frm-label"><?php _e( 'Thousand Separator', 'flone' ); ?></div>
			...
			<li>
				<div class="frm-label"><?php _e( 'Decimal Separator', 'flone' ); ?></div>
			...
			<li>
				<div class="frm-label"><?php _e( 'Number of Decimals', 'flone' ); ?></div>
			...
			<li>
				<div class="frm-label"><?php _e( 'Exchange Rate', 'flone' ); ?></div>
			...
			<li style="text-align: right;">
			   <input type="submit" id="currency-submit" value="<?php _e( 'Save', 'flone' ); ?>">
			</li>
		</ul>
	</form>
</div>
