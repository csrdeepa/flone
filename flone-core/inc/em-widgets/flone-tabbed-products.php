...
class Flone_Tabbed_Products extends Widget_Base {



    public function get_name() {

        return 'flone_tabbed_products';
    ...
    public function get_title() {
        ...
        return __( 'Tabbed Products', 'flone' );
	...
	public function flone_content_fields(){
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'label' => __( 'Product Navigation style', 'flone' ),
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'label' => __( 'Navigation Alignment', 'flone' ),
...
public function flone_style_fields(){
    ...
    'item_navibox_heading',

    [

        'label' => __( 'Nav Menu Box', 'flone' ),
...
$this->add_group_control(
        ...
        [
            ...
            'name' => 'border_nav_menu',

            'label' => __( 'Read More Border', 'ftagementor' ),

            'selector' => '{{WRAPPER}} .product-tab-list-2.flone-product-tab-list.nav',
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'label' => __( 'Box Padding', 'ftagementor' ),
            ...
            'selectors' => [
                ...
                '{{WRAPPER}} .product-tab-list-2.flone-product-tab-list.nav' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'label' => __( 'Box Margin', 'ftagementor' ),
            ...
            'selectors' => [
                ...
                '{{WRAPPER}} .product-tab-list-2.flone-product-tab-list.nav' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	...
	$this->add_control(
	    ...
	    [
	        ...
	        'label'     => __( 'Wishlist Icon Color', 'flone' ),

	        'type'      => Controls_Manager::COLOR,

	        'selectors' => [

	            '{{WRAPPER}} .flone-product-tab-st5 .yith-wcwl-add-button>a,.flone-product-tab-st5 .yith-wcwl-wishlistexistsbrowse.show a i,{{WRAPPER}} .yith-wcwl-wishlistexistsbrowse.show a i ' => 'color: {{VALUE}};',
	...
	$this->add_control(
	    ...
	    [
	        ...
	        'label'     => __( 'Wishlist BG Color', 'flone' ),

	        'type'      => Controls_Manager::COLOR,

	        'selectors' => [

	            '{{WRAPPER}} .flone-product-tab-st5 .yith-wcwl-add-to-wishlist' => 'background-color: {{VALUE}};',
	...
	$this->add_control(
	    ...
	    'wishlist_bg_color_hvoer',

	    [

	        'label'     => __( 'Wishlist Hover BG Color', 'flone' ),

	        'type'      => Controls_Manager::COLOR,

	        'selectors' => [

	            '{{WRAPPER}} .flone-product-tab-st5 .yith-wcwl-wishlistexistsbrowse.show,{{WRAPPER}} .flone-product-tab-st5 .yith-wcwl-add-to-wishlist:hover' => 'background: {{VALUE}};',
...
protected function render( $instance = [] ) {
	...
	if($settings['nav_align'] == 'default' && $settings['nav_style'] == 1){

		$nav_align_class = 'justify-content-center';

	} elseif($settings['nav_align'] == 'default' && $settings['nav_style'] == 2) {

		$nav_align_class = 'justify-content-start';

	} else {

		$nav_align_class = 'justify-content-' . $settings['nav_align'];
...
<div class="flone_tabbed_products_area flone_section_<?php echo esc_attr($id); ?> ">

	<div class="product-tab-list<?php echo esc_attr($settings['nav_style'] == '2' ? '-2' : '') ?> flone-product-tab-list nav pb-55 <?php echo esc_attr($nav_align_class); ?>">
					...
					while ( $wp_query->have_posts() ) {
						...
						$image_size = apply_filters( 'single_product_archive_thumbnail_size', $crop_size );
						 ...
						 ?>
						 	...
						 	<div <?php if( $product_layout_carousel == 'carousel' ){  wc_product_class(' product');}else{wc_product_class('col-xl-3 col-md-6 col-lg-4 col-sm-6 product');} ?>>
						...
						<?php elseif($settings['style'] == '4'): ?>
						 	...
						 	<div <?php if( $product_layout_carousel == 'carousel' ){  wc_product_class(' product');}else{wc_product_class('col-xl-3 col-md-6 col-lg-4 col-sm-6 product'); } ?>>
								...
								<div class="flone-product-wrap product-wrap-2 mb-25 scroll-zoom flone-product-st4">
						...
						<div class="flone-product-wrap product-wrap-2 mb-25 scroll-zoom<?php  if($settings['style'] == '5'){echo ' flone-product-tab-st5';} ?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new Flone_Tabbed_Products() );