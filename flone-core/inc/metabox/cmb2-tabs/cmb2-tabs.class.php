...
class CMB2_Tabs {
	...
	public function admin_assets() {
		// Css
		wp_enqueue_style( 'dtheme-cmb2-tabs', FLONE_CORE_URI . '/inc/metabox/cmb2-tabs/assets/css/cmb2-tabs.css', array(), '1.0.1' );

		// Js
		wp_enqueue_script( 'jquery-ui' );
		wp_enqueue_script( 'dtheme-cmb2-tabs', FLONE_CORE_URI . '/inc/metabox/cmb2-tabs/assets/js/cmb2-tabs.js', array( 'jquery-ui-tabs' ) );
	}
