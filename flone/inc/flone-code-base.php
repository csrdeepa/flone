<?php
if(!class_exists("FloneWooCommerceBase")) {
    class FloneWooCommerceBase {
        public $key = "6A86C65B8780BE13";
        private $product_id = "1";
        private $product_base = "flone";
        ...
        function __construct($plugin_base_file='')
        {
            ...
            if($this->hasCheckUpdate) {
                if(function_exists("add_action")){
                    add_action( 'admin_post_flone_fupc', function(){
                    ...
                    if($this->isTheme){
                        ...
                        add_filter( 'plugin_row_meta', function($links, $plugin_file ){
                            if ( $plugin_file == plugin_basename( $this->pluginFile ) ) {
                                $links[] = " <a class='edit coption' href='" . esc_url( admin_url( 'admin-post.php' ) . '?action=flone_fupc' ) . "'>Update Check</a>";
                            }
                            return $links;
                        }, 10, 2 );
