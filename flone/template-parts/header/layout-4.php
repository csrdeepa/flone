 ...
 * Template part for displaying header layout 4
...
$header_2_wrapper_class = array('flone_header_4 header-area header-padding-3 header-res-padding clearfix header_style_4');
...
<header id="masthead" class="<?php echo esc_attr(implode(' ', $header_2_wrapper_class)); ?>">
    ...
    <div class="<?php echo esc_attr($container_class); ?> <?php echo esc_attr($sticky_class); ?>">
        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-6 d-none d-lg-block item_1">
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-4 item_2">
            ...
            <div class="col-xl-5 col-lg-4 col-md-6 col-8 item_3">
        ...
        <div class="mobile-menu-area white-mobile-menu">
