...
<form id="yith-wcwl-form" action="<?php echo esc_url($form_action); ?>" method="post" class="woocommerce">
        ...
        <?php if( $is_custom_list ): ?>
            ...
            <div class="hidden-title-form">
                ...
                <button>
                    ...
                    <?php echo esc_html__( 'Save','flone' )?>

                </button>

                <a class="hide-title-form btn button">

                    <?php echo apply_filters( 'yith_wcwl_cancel_wishlist_title_icon', '<i class="fa fa-times"></i>' )?>

                    <?php echo esc_html__( 'Cancel','flone' )?>
    ...
    <?php
     ...
     <div class="table-responsive cart-table-content">
    	...
    	<table class="table shop_table cart woocommerce-cart-form__contents text-center" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo esc_attr( $wishlist_id ) ?>" data-token="<?php echo esc_attr( $wishlist_token ) ?>">
            ...
            <tr>
    	        ...
    	        <th class="product-thumbnail">
    	            ...
    	            <span class="nobr"><?php echo esc_html__( 'Image', 'flone' ); ?></span>
                ...
                <th class="product-name">
                    ...
                    <span class="nobr"><?php echo apply_filters( 'yith_wcwl_wishlist_view_name_heading', esc_html__( 'Product Name','flone' ) ) ?></span>
                ...
                <?php if( $show_price ) : ?>
                    ...
                    <th class="product-price">
                        ...
                        <span class="nobr">
                            ...
                            <?php echo apply_filters( 'yith_wcwl_wishlist_view_price_heading', esc_html__( 'Unit Price','flone' ) ) ?>
                ...
                <?php if( $show_stock_status ) : ?>
                    ...
                    <th class="product-stock-status">
                        ...
                        <span class="nobr">
                            ...
                            <?php echo apply_filters( 'yith_wcwl_wishlist_view_stock_heading', esc_html__( 'Stock Status','flone' ) ) ?>
                ...
                <?php if( $show_last_column ) : ?>
                    ...
                    <th class="product-add-to-cart">
                        ...
                        <span class="nobr"><?php echo esc_html__( 'Add To Cart', 'flone' ); ?></span>
    	        ...
    	        <?php if( $is_user_owner ): ?>
    		        ...
    		        <th class="product-remove">
                        ...
                        <span class="nobr"><?php echo esc_html__( 'Remove', 'flone' ); ?></span>      
            ...
            if( count( $wishlist_items ) > 0 ) :
                    ...
                    if( $product && $product->exists() ) :
                        ...
                        <tr id="yith-wcwl-row-<?php echo esc_attr( $item['prod_id'] ) ?>" data-row-id="<?php echo esc_attr( $item['prod_id'] ) ?>">
                            ...
                            <?php if( $show_price ) : ?>
                                ...
                                <td class="product-price">
                                    ...
                                    echo wp_kses_post( $base_product ) ? $product->get_price_html() : apply_filters( 'yith_free_text', esc_html__( 'Free!','flone' ) ); 
                            ...
                            <?php if( $show_stock_status ) : ?>
                                ...
                                <td class="product-stock-status">
                                    ...
                                    <?php echo wp_kses_post( $stock_status ) == 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . esc_html__( 'Out of Stock','flone' ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html__( 'In Stock','flone' ) . '</span>'; ?>
                            ...
                            <td class="product-add-to-cart">
    	                        ...
    	                        if( $show_dateadded && isset( $item['dateadded'] ) ):
    								...
    								echo '<span class="dateadded">' . sprintf( esc_html__( 'Added on : %s','flone' ), date_i18n( get_option( 'date_format' ), strtotime( $item['dateadded'] ) ) ) . '</span>';
    	                        ...
    	                        <select class="change-wishlist selectBox">
    		                        ...
    		                        <option value=""><?php esc_html__( 'Move','flone' ) ?></option>
    		                        ...
    		                        ?>
    			                        ...
    			                        <option value="<?php echo esc_attr( $wl['wishlist_token'] ) ?>">
    				                        ...
    				                        if( $wl['wishlist_privacy'] == 1 ){
    					                        ...
    					                        $wl_privacy = esc_html__( 'Shared','flone' );

    				                        }

    				                        elseif( $wl['wishlist_privacy'] == 2 ){

    					                        $wl_privacy = esc_html__( 'Private','flone' );

    				                        }

    				                        else{

    					                        $wl_privacy = esc_html__( 'Public','flone' );
    	                        ...
    	                        <?php if( $is_user_owner && $repeat_remove_button ): ?>
                                    ...
                                    <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove_from_wishlist button" title="<?php echo esc_attr__( 'Remove this product','flone' ) ?>"><?php echo esc_html__( 'Remove','flone' ) ?></a>
    	                ...
    	                <td class="product-remove">
    	                    ...
    	                    <div>
    	                        ...
    	                        <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove remove_from_wishlist" title="<?php echo esc_attr( 'Remove this product','flone' ) ?>"><i class="fa fa-times"></i></a>
                ...
                <tr>
                    ...
                    <td colspan="<?php echo esc_attr( $column_count ) ?>" class="wishlist-empty"><?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', esc_html__( 'No products were added to the wishlist','flone' ) ) ?></td>
	...
	<div id="ask_an_estimate_popup">
		...
		<form action="<?php echo esc_url( $ask_estimate_url ); ?>" method="post" class="wishlist-ask-an-estimate-popup">
			...
			<?php if( ! is_user_logged_in() ): ?>
				...
				<label for="reply_email"><?php echo apply_filters( 'yith_wcwl_ask_estimate_reply_mail_label', esc_html__( 'Your email','flone' ) ) ?></label>
			...
			<button class="btn button ask-an-estimate-button ask-an-estimate-button-popup" >
				...
				<?php echo apply_filters( 'yith_wcwl_ask_an_estimate_text', esc_html__( 'Ask for an estimate','flone' ) ) ?>
